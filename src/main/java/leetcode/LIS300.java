...
public class LIS300 {
	...
	public static List<ArrayList<ArrayList<Integer>>> getAllSolution(ArrayList<ArrayList<Integer>> list, int n) {
	...
	public static ArrayList<ArrayList<Integer>> insertCar(int[] begins, int index, List<ArrayList<Integer>> list) {
